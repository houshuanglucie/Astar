...
//		private JPanel panel = new JPanel();
	    ...
	    Container p;   
	    Point grid;
	    public Draw(int en_des[][],int obstacle[][],int trace[][],int x_length,int y_length,ArrayList<LinkedList<Node>> array) //鍦ㄤ袱鐐逛箣闂寸敾涓�鏉＄嚎
		    {   
...
//	            	}
		    ...
		    public void paint(Graphics g)
		    {
		        ...
		        Image image = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\error.png");
		        Image image1 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\green_arrow_up.png");
		        Image image2 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\green_arrow_right_up.png");
		        Image image3 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\green_arrow_left.png");
		        Image image4 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\green_arrow_right.png");
		        Image image5 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\green_arrow_left_down.png");
		        Image image6 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\green_arrow_right_up.png");
		        Image image7 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\green_arrow_down.png");
		        Image image8 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\green_arrow_right_down.png");
		        Image image9 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\start.png");
		        Image image10 = tool.getImage("E:\\大四下学期\\ES21-建模与仿真--周隽\\代码需要的插图\\end.png");
...
//		    	}
	    	...
	    	for(int i=1;i < this.trace[0].length-1;i++)
	    	{
	    		g.drawLine(80+stepsize*this.trace[0][i]+stepsize/2,
	    				80+stepsize*(y_length-1-this.trace[1][i])+stepsize/2,
	    				80+stepsize*this.trace[0][i+1]+stepsize/2,
	    				80+stepsize*(y_length-1-this.trace[1][i+1])+stepsize/2);
//	    		g.fillRect(80+stepsize*this.trace[0][i], 80+stepsize*(y_length-1-this.trace[1][i]), stepsize,stepsize);
//	    		try 
//	    		{
